...
$(function(){
    ...
    //pegar previsao do local
    var accuweatherAPIkey = "obVu0NdouVUwLu9ljJ7lXC3o2b3of3gf";
    var mapboxToken = "pk.eyJ1IjoiZmVzY2FydmFsaG8iLCJhIjoiY2twbGFraW1jMHBvbjJ2cWtycHl1bW92cyJ9.iUmUg0NNLCUGBNBFBeIelQ";
    ...
    var weatherObject = {
        ...
        function pegarPrevisaoHoraaHora (localCode) {
            ...
            $.ajax ({
                url : "http://dataservice.accuweather.com/forecasts/v1/hourly/12hour/"+localCode+"?apikey=" + accuweatherAPIkey + "&language=pt-BR&details=28143&metric=true",
                type : "GET",
                dataType: "json",
        ...
        function preencherPrevisao5Dias(previsoes) {
            ...
            var diasSemana = ["Domingo", "Segunda-feira", "Terça-feira", "Quarta-feira", "Quinta-feira", "Sexta-feira", "Sábado"];
                ...
                for (var a = 0; a < previsoes.length; a++) {
                    ...
                    var dias_semana = diasSemana[dataHoje.getDay()];

                    var iconNumber = previsoes[a].Day.Icon <= 9 ? "0" + String(previsoes[a].Day.Icon) 
                    : String(previsoes[a].Day.Icon); 
                    ...
                    elementoHTMLDias +=       dias_semana;
                    elementoHTMLDias +=    '</div>';
                    elementoHTMLDias +=    '<div style="background-image: url(\''+iconeClima+'\')" class="daily_weather_icon"></div>';
                    elementoHTMLDias +=    '<div class="max_min_temp">';
                    elementoHTMLDias +=      minima + '&deg; /'+ maxima +'&deg;';
                    elementoHTMLDias +=   '</div>';
                    elementoHTMLDias += '</div>';
                    elementoHTMLDias +='</div>';
        ...
        function pegarPrevisao5Dias(localCode){
            $.ajax ({
                url : "http://dataservice.accuweather.com/forecasts/v1/daily/5day/" +localCode+"?apikey=" + accuweatherAPIkey + "&language=pt-BR&details=28143&metric=true",
                type : "GET",
                dataType: "json",
                success: function(data){
        ...
        function pegarTempoAtual(localCode) {
            ...
            $.ajax ({
                url : "http://dataservice.accuweather.com/currentconditions/v1/"+localCode+"?apikey=" + accuweatherAPIkey + "&language=pt-BR&details=28143",
                type : "GET",
                dataType: "json",
                success: function(data){
                 /*    console.log("current_conditions",data); */
                    ...
                    var iconNumber = data[0].WeatherIcon <= 9 ? "0" + String(data[0].WeatherIcon) 
        ...
        function pegarCoordernadasDaPesquisa(input) {
        ...
        function pegarCoordenadasDoIP() {
            ...
            var lat_padrao = -23.220999038811073;
            var long_padrao = -45.90216008358402;
        ...
        function gerarErro(mensagem) {
            ...
            $('.refresh-loader').hide();
            $("#erro-solcitacao").text(mensagem);
            $("#erro-solcitacao").slideDown();
            window.setTimeout(function(){
                $("#erro-solcitacao").slideUp();
            },4000);
       ...
       pegarCoordenadasDoIP();
        ...
        $("#search-button").click(function(){
            ...
            if (local) {
                pegarCoordernadasDaPesquisa(local);
            } else {
